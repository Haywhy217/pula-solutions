...
import vec3 from '../assets/Images/vector3.png';
import vec4 from '../assets/Images/vector4.png';
import vec5 from '../assets/Images/vector5.png';

const InsightSection = () => {
  return (
    <div className='w-full bg-primary p-6  md:p-10 space-y-10 pb-20'>
      <div className='space-y-5 text-center'>
        <h3 className='font-livvic text-[32px] md:text-[40px] font-bold text-center leading-10 text-[#0ba5ec]'>Our Approach</h3>
        <h3 className='font-livvic text-[28px] md:text-[32px]  font-bold text-center leading-10 text-[#f3f4f6] max-w-2xl mx-auto'> Integrating innovative technology and data-driven insights</h3>
        <p className='font-inter text-[14px] md:text-[16px] font-normal leading-5 text-[#98a2b3] max-w-4xl mx-auto text-left'>At Pula, we have refined the index insurance model to address the specific needs and challenges faced by smallholder farmers in emerging markets. Our approach integrates innovative technology and data-driven insights to deliver accessible, affordable, and effective insurance solutions. Here's how we implement index insurance through our platform:</p>
      </div>
