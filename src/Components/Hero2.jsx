...
const Hero2 = () => {
  ...
  return (
    <div className='w-full h-96 bg-hero-pattern bg-cover bg-no-repeat bg-center linear-gradient(0deg, #000000 100%, #263c28 80%, #000000 0%, #263c28 22%) '> 
