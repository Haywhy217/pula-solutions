  ...
  return (
    <div className='w-full h-auto flex flex-col items-center justify-center bg-pressColor p-10'>
      <div className='w-3/4 px-4 gap-5'>
          <h1 className='text-center font-livvic leading-7 text-[28px] md:text-[32px] lg:text-[40px] font-bold md:leading-6 lg:leading-10'>We have won prestigious awards for our innovative products and impact</h1>
